          ...
          <div className="lg:w-[456px]  bg-[#E8F4FD] h-[204px] rounded-xl overflow-y-hidden">
            <div className="p-4 flex">
              ...
              <div className="ml-2 w-[calc(100%-3rem)]">
                <div className="lg:text-sm text-xs font-medium text-[#191C1F] whitespace-normal"></div>
                <div className="text-sm font-normal text-[#3E5765] whitespace-normal mt-2">
                  November 1, 1976 Diffie-Hellman Day Share Whitfeld Diffie and
                  Martin E. Hellman release their proposal for a cryptographic
                  protocol used for secure communication over an insecure
                  channel. Their paper, titled “New Directions in Cryptography,”
                  provided a revolutionary method for secure key exchange
                  without relying on a pre-shared secret. Most notably, it
                  presented an implementation of public and private key pairs
                  for secure communication over public channels.
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="p-4 flex">
              ...
              <div className="ml-2 w-[calc(100%-3rem)]">
                ...
                <div className="lg:text-sm text-xs font-normal text-[#3E5765] whitespace-normal mt-2 over">
                  DigiCash is founded Share David Chaum, a cryptographer,
                  founded DigiCash and subsequently created one of the first
                  electronic money corporations. It was one of the first
                  attempts to create a completely anonymous, secure digital
                  payment system. DigiCash was based on Blind Signature
                  Technology, an invention of Chaum’s that built upon
                  technological developments for public and private keys.
                </div>
              </div>
            </div>
          </div>
